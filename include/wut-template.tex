...
\newcommand{\defineverbatim}[1]{\DefineVerbatimEnvironment{Highlighting}{Verbatim}{breaklines, breakanywhere, highlightcolor=emphasizecolor, highlightlines=#1, breakbeforesymbolpre={}, $if(forcelinenos)$numbers=$forcelinenos$,$endif$commandchars=\\\{\}}}
\defineverbatim{}
