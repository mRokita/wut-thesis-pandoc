...
\newcommand{\defineverbatim}[1]{\DefineVerbatimEnvironment{FVHighlighting}{Verbatim}{breaklines, fontsize=\$if(codefontsize)$$codefontsize$$else$footnotesize$endif$, $if(forcelinenos)$numbers=$if(linenos)$$linenos$$else$left$endif$, $endif$breakanywhere, highlightcolor=emphasizecolor, highlightlines=#1, commandchars=\\\{\}}}
\defineverbatim{}
